...
#working_dir = '/home/dmoraes/spider.data/working/' + data_version

data_file = 'std_offer_specs_1_refined_1_no-cpu-model_str.csv'
working_dir = '/home/dmoraes/datasets/1/'
...
reg = Regression(r['read.table'](data_file, header = True, sep = ",",
    quote='', stringsAsFactors = True), working_dir)
